...
7. [Starter Certifications](#starter-certifications)
8. [Advanced Topics](#advanced-topics)
    - [Advanced Courses](#advanced-courses)
    - [Specialized Certifications](#specialized-certifications)
9. [Career Paths in Cybersecurity](#career-paths-in-cybersecurity)
...
- [**Practical Networking Playlist**](https://www.youtube.com/watch?v=bj-Yfakjllc&list=PLIFyRwBY_4bRLmKfP1KnZA6rZbRHtxmXi&index=2)
...
- **Udemy:** Udemy courses can be great too, but try to avoid the junk out there. Here are some courses I recommend if you are interested in the Cloud.
  - [AWS Certified Cloud Practitioner](https://www.udemy.com/course/aws-certified-cloud-practitioner-new/?couponCode=ST19MT61724)
      - The AWS (Amazon Web Services) CCP is an entry-level AWS Cloud certificate.
...
- [**ISC2 Certificate in Cybersecurity**](https://www.isc2.org/certifications/cc)
...
- [**SANS Institute Courses**](https://www.sans.org/cyberaces/)
